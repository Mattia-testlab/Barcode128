        ...
        try:
            ...
            with col2:
                ...
                with st.expander("🎛️ Regolazioni Layout"):
                    ...
                    lo_gap = st.slider("Spazio testo-barcode (mm) [Standard: 1.0]", 0.5, 4.0, 1.0, 0.5,
                                       help="Distanza tra le righe di testo e il barcode")
                    lo_ls = st.slider("Spaziatura righe testo (mm) [Standard: 3.0]", 2.0, 5.0, 3.0, 0.5,
                                      help="Distanza tra le righe di testo superiore")
                    lo_fs = st.slider("Dimensione font (pt) [Standard: 9]", 6, 14, 9, 1,
